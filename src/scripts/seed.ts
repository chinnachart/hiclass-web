...
const run = async () => {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      mainPhone: '099-493-4863',
      footerAbout:
        'ผู้จำหน่ายรถยนต์ไฟฟ้า BYD อย่างเป็นทางการ พร้อมศูนย์บริการมาตรฐานและบริการรถเช่าระหว่างซ่อม',
      financeRate: 2.89,
      financeRates: [
        { down: 30, r48: 1.98, r60: 2.55, r72: 3.09, r84: 3.79 },
        { down: 25, r48: 1.98, r60: 2.79, r72: 3.19, r84: 3.89 },
        { down: 20, r48: 2.79, r60: 2.99, r72: 3.39, r84: 3.99 },
        { down: 15, r48: 3.29, r60: 3.59, r72: 3.79, r84: 4.49 },
        { down: 10, r48: 3.89, r60: 4.19, r72: 4.49, r84: 4.79 },
      ],
