...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      // โพสต์เพจ BYD RÊVER Thailand (แคมเปญ 10,000 Milestone 12–30 ก.ย. 69) พิมพ์ลิงก์ผิดเป็น /test-driver
      // ไม่ permanent (307) เผื่อเปลี่ยน utm ภายหลัง · utm ติดไปกับลีดใน Cinco
      { source: '/test-driver', destination: '/test-drive?utm_source=facebook&utm_medium=social&utm_campaign=rever-10000-milestone', permanent: false },
      { source: '/test-driver/:path*', destination: '/test-drive?utm_source=facebook&utm_medium=social&utm_campaign=rever-10000-milestone', permanent: false },
